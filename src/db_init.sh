...
/usr/local/bin/psql -U $POSTGRES_USER -d $POSTGRES_DB -a -f /scripts/aggregated.sql
/usr/local/bin/psql -U $POSTGRES_USER -d $POSTGRES_DB -a -f /scripts/views.sql
/usr/local/bin/psql -U $POSTGRES_USER -d $POSTGRES_DB -a -f /scripts/triggers.sql
